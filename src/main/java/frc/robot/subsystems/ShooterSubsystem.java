...
public class ShooterSubsystem extends Subsystem {
   ...
   * the fact that the zero point of the real turret may be in an awkward location.
   */
  ...
  /**
   * Convert from an absolute position (given by the encoder) to an adjusted position (what we use)
  ...
  /**
   * Convert from the relative/adjusted position (what we use) to the absolute position
